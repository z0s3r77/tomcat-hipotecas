	...
	<div class="container">
		...
		<form action="HipotecaController" method="post" class="form-group">
			<label for="capital" class="form-label">Capital:</label> <input
				...
				class="form-label mt-2">Frecuencia de pago en meses:</label> <select
				id="frecuenciaDePagoEnMeses" name="frecuenciaDePagoEnMeses" required
				class="form-control">
				<option value="1">Mensual</option>
				<option value="3">Trimestral</option>
				<option value="12">Anual</option>
			</select> <label for="plazoDeAmortizacionEnAnnos" class="form-label mt-2">Plazo
				de amortización en años:</label> <input type="number"
				id="plazoDeAmortizacionEnAnnos" name="plazoDeAmortizacionEnAnnos"
				min="0" required class="form-control"> <input type="submit"
				value="Calcular" class="btn btn-primary mt-3">
		</form>
	</div>
	<br>
	<br>
